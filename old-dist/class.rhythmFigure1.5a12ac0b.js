...
})({"ADvme":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "479659da5a12ac0b";
...
},{}],"ihbg2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "rhythmFigure2", ()=>rhythmFigure2) /* const envRhythmFigure1 = new AmplitudeEnvelope({
    attack: 0.01,
    decay: 0.5,
    sustain: 0.0,
    release: 0.0,
}).connect(masterRhythmFigureGain1); */  /* if (rhythmDensity === 1) {
...
let oscillatorRhythmFigure1 = [
    ...Array(32)
];
let gainsRythmFigure1 = [
    ...Array(32)
];
...
frequenciesRF1.forEach((item, index)=>{
    frequenciesRF1[index] = (0, _tone.MidiClass).mtof((0, _tone.MidiClass).ftom(Math.pow(index + 2, 2)));
});
frequenciesRF13.forEach((item, index)=>{
    frequenciesRF13[index] = (0, _tone.MidiClass).mtof((0, _tone.MidiClass).ftom(Math.pow(index + 2, 3)));
});
class rhythmFigure2 {
    out;
    env;
    constructor(volume){
        ...
        gainsRythmFigure1 = gainsRythmFigure1.map((item, index)=>{
            return new (0, _tone.Gain)({
                gain: exponentialGain(index, 15, 200)
            }).connect(this.env);
        });
        oscillatorRhythmFigure1 = oscillatorRhythmFigure1.map((item, index)=>{
            return new (0, _tone.Oscillator)({
                frequency: frequenciesRF1[index],
                type: "sine"
            }).connect(gainsRythmFigure1[index]).start();
        });
...
},{"tone":"2tCfN","@parcel/transformer-js/src/esmodule-helpers.js":"aRELh"}]},["ADvme"], null, "parcelRequired404")

//# sourceMappingURL=class.rhythmFigure1.5a12ac0b.js.map
